        ...
        <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                ...
                <form action="../index.php" method="POST">
                    <button class="border-0 bg-transparent text-danger" name="logOut">
               ...
               with font-awesome or any other icon font library -->
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="../education/addEdu.php" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Add Details</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="../experince/addExperince.php" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Add Details</p>
                                        </a>
                                    </li>
