<?php 
      ...
      include "../back/dbcont.php";
        $data = $cont->prepare("SELECT * FROM `experience`");
        $data->execute();
?>
                                                ...
                                                <form action="../back/ExperinceController.php" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                            <label>Year</label>
                                                            <input type="number" value="<?php echo $row['year'] ?>" name="year" class="form-control" required>
                                                            </div>
                                                            </div>
                                                            <div class="col-12">
                                                            <div class="form-group">
                                                            <label>Company</label>
                                                            <input type="text" value="<?php echo $row['company'] ?>" name="company" class="form-control" required>
                                                            </div>
                                                            <div class="col-12">
                                                            <div class="form-group">
                                                                <label>Description</label>
                                                                <textarea class="form-control" rows="3" placeholder="Enter ..." name="description"><?php echo $row['descraption'] ?></textarea>
                                                            </div>
                                                            </div>
                                                            </div>
                                                        </div>
