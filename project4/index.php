...
<body class="theme-red">
    ...
    <div class="vg-page page-about" id="about">
        <div class="container py-5">
            <div class="row">
            <?php $about = getData::about()?>      
                <div class="col-lg-4 py-3">
                    <div class="img-place wow fadeInUp">
                        <img src="Images/<?php echo $about['img']?>" alt="">
                    </div>
                </div>
                <div class="col-lg-6 offset-lg-1 wow fadeInRight">

                    <h1 class="fw-light"><?php echo $about['name']?></h1>
                    <h5 class="fg-theme mb-3"><?php echo $about['job']?></h5>
                    <p class="text-muted"><?php echo $about['description']?></p>
                    <ul class="theme-list">
                        <li><b>From:</b> <?php echo $about['from']?></li>
                        <li><b>Lives In:</b> <?php echo $about['live_in']?></li>
                        <li><b>Age:</b> <?php echo $about['age']?></li>
                        <li><b>Gender:</b> <?php echo $about['gender']?></li>
                    </ul>
                        ...
                        <div class="col-md-6">
                            <div class="px-lg-3">
                                <div class="progress-wrapper wow fadeInUp">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" style="width: <?php echo $row['number'] ?>%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"><?php echo $row['number'] ?>%</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 wow fadeInRight">
                    ...
                    <ul class="timeline mt-4 pr-md-5">
                        <?php
                        $eduction =  getData::eduction();
                        while($row = $eduction->fetch()){
                        ?>
                        <li>
                            <div class="title"><?php echo $row['year']?></div>
                            <div class="details">
                                <h5><?php echo $row['title']?></h5>
                                <small class="fg-theme"><?php echo $row['universty']?></small>
                                <p><?php echo $row['descraption']?></p>
                            </div>
                        </li>
                        <?php
                         }
                ...
                <div class="col-md-6 wow fadeInRight" data-wow-delay="200ms">
                    ...
                    <ul class="timeline mt-4 pr-md-5">
                         <?php
                            ...
                            while($row = $experience->fetch()){
                                ?>
                            <li>
                                <div class="title"><?php echo $row['year']?></div>
                                <div class="details">
                                    <h5><?php echo $row['title']?></h5>
                                    <small class="fg-theme"><?php echo $row['company']?></small>
                                    <p><?php echo $row['descraption']?></p>
                                </div>
                            </li>
                            <?php
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="card card-service wow fadeInUp">
                        <div class="icon">
                            <img width="50" src="Images/<?php echo $row['img']?>" alt="">
                        </div>
                        <div class="caption">
